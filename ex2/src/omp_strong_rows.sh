...
# compile the row-decomposition source
mpicc -fopenmp mandel_rows.c -o mandel_rows_omp -lm
...
for THREADS in {1..128}; do
    ...
    echo "ROWS OMP: cores=1, threads=${THREADS}, width=${n}, height=${n}, time=${EXEC_TIME}"
done